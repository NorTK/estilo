...
.. toctree::
   :maxdepth: 2
   :numbered:
   :caption: Contenido de la guía:

   01-principios-y-filosofia
   02-arquitectura-modular
   03-procedimientos-y-verificacion
   04-convenciones-cli-y-tipografia
   05-mensajeria-y-gestion-de-errores
   06-estandar-marcado-rst
   07-glosario-y-vocabulario-tecnico
